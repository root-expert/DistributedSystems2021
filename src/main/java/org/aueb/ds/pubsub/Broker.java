...
public class Broker implements Node, Serializable, Runnable, Comparable<Broker> {
    ...
    /**
     * videoList: is a list with all videos(already chunked from the publisher) concerning a certain topic.
     * It only contains the topics the broker is associated with.
     */
